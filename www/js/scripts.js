...
function recordar_clave()
{
    ...
    if (validar1 == 1)
    {
        ...
        setTimeout(function () {
            post_ajax('polivalente', 'formulario_recordar_clave', 'https://www.mycorner360.com/app/recordar_clave.php');
        }, 1000);
...
var ua = 'UA-92835463-1';
ga('create', ua, {'storage': 'none', 'clientId': device.uuid});
ga('set', 'checkProtocolTask', null);
ga('set', 'checkStorageTask', null);
ga('send', 'pageview', {'page': 'Mycorner360 APP'});
